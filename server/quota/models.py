...
PricingRuleModel.__table__.comment = TABLE_COMMENTS.get("nlp_pricing_rules")
UsageEventModel.__table__.comment = TABLE_COMMENTS.get("nlp_usage_events")
...
class QuotaBucketModel(Base):
    ...
    balance_micro: Mapped[int | None] = mapped_column(
        BIGINT, nullable=True, default=None
    )
...
QuotaPolicyModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_policies")
PolicyBindingModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_policy_bindings")
QuotaBucketModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_buckets")
QuotaConcurrencyLockModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_concurrency_locks")
QuotaReservationModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_reservations")
QuotaLedgerEntryModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_ledger_entries")
QuotaGrantModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_grants")
QuotaAdjustmentModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_adjustments")
QuotaCreditOperationModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_credit_operations")
QuotaRoleCreditOperationModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_role_credit_operations")
QuotaCreditScopeLockModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_credit_scope_locks")
QuotaDailyRollupModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_daily_rollups")
QuotaProviderBillingModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_provider_billing")
QuotaUsageArchiveBatchModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_usage_archive_batches")
QuotaAlertModel.__table__.comment = TABLE_COMMENTS.get("nlp_quota_alerts")
