...
function CatalogEditorLayout({ sidebarTitle, count, search, onSearch, createLabel, onCreate, canCreate = true, directory, selected, selectedTitle, selectedMeta, status, previewKey, renderContent, overlays, saveProps }: {
  sidebarTitle: string;
  count: number;
  search: string;
